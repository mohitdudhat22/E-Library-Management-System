  ...
  return (
    <div className="flex justify-center items-center h-screen bg-gradient-to-r from-[#222831] to-[#393A45]">
      <div className="max-w-2xl w-1/2 p-8 bg-[#222831] rounded-3xl shadow-2xl h-auto">
        <h2 className="text-3xl font-bold text-[#00ADB5] text-center mb-8">User Register</h2>
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="relative">
            <select
              ...
              required
              className="block w-full p-4 text-[#F7F7F7] bg-[#393A45] border border-[#393A45] rounded-2xl appearance-none"
            >
              <option value="">Select Role</option>
              <option value="user">User</option>
              <option value="admin">Admin</option>
            </select>
            <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-[#F7F7F7]">
          ...
          <div className="flex justify-between items-center">
            ...
            <p className="text-[#F7F7F7]">
              Already have an account? <a href="/login" className="text-[#00ADB5] hover:text-[#0097A7]">Login</a>
            </p>
          </div>
        </form>
      </div>
