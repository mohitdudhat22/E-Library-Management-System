      ...
      <div className="p-6">
        <div className="flex items-center mb-4 h-auto">
          <div className="w-full h-full bg-secondary rounded-lg mr-4 flex-shrink-0">
            <img src="https://cdn.kobo.com/book-images/1d595662-5d4b-441e-96cc-209125e2336f/1200/1200/False/rich-dad-poor-dad-for-teens-1.jpg" alt="Book Cover" className="w-full h-full object-cover rounded-lg" />
          </div>
        </div>
        <div className="flex flex-col space-y-3">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className={`w-8 h-6 flex items-center justify-center rounded-md px-6 ${available ? 'bg-green-500' : 'bg-red-500'}`}>
